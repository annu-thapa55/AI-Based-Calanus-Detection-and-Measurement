...
def contours(cropImg,x,y):
      ...
      ret1, th1 = cv2.threshold(gImg, 0, 255, cv2.THRESH_BINARY + cv2.THRESH_OTSU)
...
if __name__ == '__main__':
      ...
      # Load image.
      frame = cv2.imread("/Users/jackyan_1/PycharmProjects/plankton/test/res/img13689_10647.jpg")
      # Give the weight files to the model and load the network using       them.
      modelWeights = "/Users/jackyan_1/PycharmProjects/plankton/test/model/yolov5s.onnx"
